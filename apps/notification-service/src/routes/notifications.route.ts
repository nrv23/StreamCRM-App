...
export class NotificationRoutes implements IRoutes {
    ...
    BuildRoutes(): Router {
        ...
        this._router.patch('/:notification_id/read', markAsReadNotificationValidator, validateRequest, fakeAuth, this._notificationController.markAsRead.bind(this._notificationController));
