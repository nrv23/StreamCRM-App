...
export class NotesRoutes {
    ...
    constructor() {
        ...
        this._noteService = new NoteService(this._unitOfWork, WinstonLogger.getInstance(env.elastic_search_url, 'notes-module', 'debug', env.index_elastic_search_name));
    ...
    BuildRoutes() {
        ...
        this._router.get('/', getNoteValidator, validateRequest, fakeAuth, this._noteController.search.bind(this._noteController));
        return this._router;
    }
}
