...
CREATE INDEX idx_campaigns_external_id
...
CREATE INDEX idx_campaign_segments_campaign_id
ON campaign_segments(campaign_id);
CREATE TABLE campaign_recipients (
  ...
  customer_external_id UUID NULL,
...
CREATE INDEX idx_campaign_recipients_customer_id
...
CREATE INDEX idx_campaign_executions_campaign_id
ON campaign_executions(campaign_id);
CREATE TABLE campaign_execution_logs (
  id SERIAL PRIMARY KEY,

  campaign_execution_id INT NOT NULL REFERENCES campaign_executions(id),
  recipient_id INT NULL REFERENCES campaign_recipients(id),
...
CREATE INDEX idx_campaign_execution_logs_execution_id
ON campaign_execution_logs(campaign_execution_id);

CREATE INDEX idx_campaign_execution_logs_recipient_id
ON campaign_execution_logs(recipient_id);
```
